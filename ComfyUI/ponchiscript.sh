...
CHECKPOINT_MODELS=(
    ...
    "https://civitai.com/api/download/models/255474?type=Model&format=SafeTensor&size=pruned&fp=fp16"
)
...
IPADAPTER_MODELS=(
    # Add URLs to IP adapter models here
...
CLIP_VISION_MODELS=(
    # Add URLs to CLIP vision models here
